...
def train_and_evaluate_SciBERT_Reranker(train_df, use_lazy_loading, documents_per_query, val_df=None, test_df=None,
    ...
    Args:
        train_df: train dataframe with columns 'text_a', 'text_b', 'labels' or csv for lazy loading
        val_df: validation dataframe with columns 'text_a', 'text_b', 'labels' or csv for lazy loading
        test_df: test dataframe with columns 'text_a', 'text_b', 'labels' or csv for lazy loading
...
if __name__ == "__main__":
    ...
    if args.use_lazy_loading:
        # train and evaluate model
        train_and_evaluate_SciBERT_Reranker(args.train_data, val_df=args.validation_data, test_df=args.test_data,
                                            use_lazy_loading=True, documents_per_query=args.documents_per_query,
        ...
        train_and_evaluate_SciBERT_Reranker(train_df, val_df=val_df, test_df=test_df,
                                            use_lazy_loading=False, documents_per_query=args.documents_per_query,
                                            use_cased=args.use_cased, exp_name=args.exp_name)
